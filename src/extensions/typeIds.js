export const typeIdToID = new Map([
	...
	['minecraft:camera_block', 629],
	['minecraft:compound', 630],
	['minecraft:ice_bomb', 631],
	['minecraft:bleach', 632],
	['minecraft:rapid_fertilizer', 633],
	['minecraft:balloon', 634],
	['minecraft:medicine', 635],
	['minecraft:sparkler', 636],
	['minecraft:glow_stick', 637],
	['minecraft:lodestone_compass', 638],
	['minecraft:netherite_sword', 639],
	['minecraft:netherite_shovel', 640],
	['minecraft:netherite_pickaxe', 641],
	['minecraft:netherite_axe', 642],
	['minecraft:netherite_hoe', 643],
	['minecraft:netherite_ingot', 644],
	['minecraft:netherite_helmet', 645],
	['minecraft:netherite_chestplate', 646],
	['minecraft:netherite_leggings', 647],
	['minecraft:netherite_boots', 648],
	['minecraft:netherite_scrap', 649],
	['minecraft:crimson_sign', 650],
	['minecraft:warped_sign', 651],
	['minecraft:crimson_door', 652],
	['minecraft:warped_door', 653],
	['minecraft:warped_fungus_on_a_stick', 654],
	['minecraft:chain', 655],
	['minecraft:music_disc_pigstep', 656],
	['minecraft:nether_sprouts', 657],
	['minecraft:soul_campfire', 658],
	['minecraft:glow_frame', 659],
	['minecraft:amethyst_shard', 660],
	['minecraft:spyglass', 661],
	['minecraft:music_disc_otherside', 662],
	['minecraft:goat_horn', 663],
	['minecraft:frog_spawn_egg', 664],
	['minecraft:tadpole_spawn_egg', 665],
	['minecraft:tadpole_bucket', 666],
	['minecraft:allay_spawn_egg', 667],
	['minecraft:warden_spawn_egg', 668],
	['minecraft:mangrove_door', 669],
	['minecraft:mangrove_sign', 670],
	['minecraft:mangrove_boat', 671],
	['minecraft:music_disc_5', 672],
	['minecraft:disc_fragment_5', 673],
	['minecraft:oak_chest_boat', 674],
	['minecraft:birch_chest_boat', 675],
	['minecraft:jungle_chest_boat', 676],
	['minecraft:spruce_chest_boat', 677],
	['minecraft:acacia_chest_boat', 678],
	['minecraft:dark_oak_chest_boat', 679],
	['minecraft:mangrove_chest_boat', 680],
	['minecraft:recovery_compass', 682],
	['minecraft:echo_shard', 683],
	['minecraft:trader_llama_spawn_egg', 684],
	['minecraft:cherry_boat', 685],
	['minecraft:cherry_chest_boat', 686],
	['minecraft:cherry_sign', 687],
	['minecraft:bamboo_sign', 688],
	['minecraft:bamboo_raft', 689],
	['minecraft:bamboo_chest_raft', 690],
	['minecraft:camel_spawn_egg', 691],
	['minecraft:angler_pottery_sherd', 692],
	['minecraft:archer_pottery_sherd', 693],
	['minecraft:arms_up_pottery_sherd', 694],
	['minecraft:blade_pottery_sherd', 695],
	['minecraft:brewer_pottery_sherd', 696],
	['minecraft:burn_pottery_sherd', 697],
	['minecraft:danger_pottery_sherd', 698],
	['minecraft:explorer_pottery_sherd', 699],
	['minecraft:flow_pottery_sherd', 700],
	['minecraft:friend_pottery_sherd', 701],
	['minecraft:guster_pottery_sherd', 702],
	['minecraft:heart_pottery_sherd', 703],
	['minecraft:heartbreak_pottery_sherd', 704],
	['minecraft:howl_pottery_sherd', 705],
	['minecraft:miner_pottery_sherd', 706],
	['minecraft:mourner_pottery_sherd', 707],
	['minecraft:plenty_pottery_sherd', 708],
	['minecraft:prize_pottery_sherd', 709],
	['minecraft:scrape_pottery_sherd', 710],
	['minecraft:sheaf_pottery_sherd', 711],
	['minecraft:shelter_pottery_sherd', 712],
	['minecraft:skull_pottery_sherd', 713],
	['minecraft:snort_pottery_sherd', 714],
	['minecraft:brush', 715],
	['minecraft:netherite_upgrade_smithing_template', 716],
	['minecraft:sentry_armor_trim_smithing_template', 717],
	['minecraft:dune_armor_trim_smithing_template', 718],
	['minecraft:coast_armor_trim_smithing_template', 719],
	['minecraft:wild_armor_trim_smithing_template', 720],
	['minecraft:ward_armor_trim_smithing_template', 721],
	['minecraft:eye_armor_trim_smithing_template', 722],
	['minecraft:vex_armor_trim_smithing_template', 723],
	['minecraft:tide_armor_trim_smithing_template', 724],
	['minecraft:snout_armor_trim_smithing_template', 725],
	['minecraft:rib_armor_trim_smithing_template', 726],
	['minecraft:spire_armor_trim_smithing_template', 727],
	['minecraft:silence_armor_trim_smithing_template', 728],
	['minecraft:wayfinder_armor_trim_smithing_template', 729],
	['minecraft:raiser_armor_trim_smithing_template', 730],
	['minecraft:shaper_armor_trim_smithing_template', 731],
	['minecraft:host_armor_trim_smithing_template', 732],
	['minecraft:flow_armor_trim_smithing_template', 733],
	['minecraft:bolt_armor_trim_smithing_template', 734],
	['minecraft:music_disc_relic', 735],
	['minecraft:armadillo_spawn_egg', 738],
	['minecraft:armadillo_scute', 739],
	['minecraft:wolf_armor', 740],
	['minecraft:wool', 743],
	['minecraft:carpet', 744],
	['minecraft:log', 745],
	['minecraft:fence', 746],
	['minecraft:stonebrick', 747],
	['minecraft:coral_block', 748],
	['minecraft:stone_block_slab', 749],
	['minecraft:stone_block_slab2', 750],
	['minecraft:stone_block_slab3', 751],
	['minecraft:stone_block_slab4', 752],
	['minecraft:double_stone_block_slab', 753],
	['minecraft:double_stone_block_slab2', 754],
	['minecraft:double_stone_block_slab3', 755],
	['minecraft:double_stone_block_slab4', 756],
	['minecraft:coral_fan', 757],
	['minecraft:coral_fan_dead', 758],
	['minecraft:sapling', 759],
	['minecraft:leaves', 760],
	['minecraft:leaves2', 761],
	['minecraft:wooden_slab', 762],
	['minecraft:red_flower', 763],
	['minecraft:double_plant', 764],
	['minecraft:double_wooden_slab', 765],
	['minecraft:coral', 766],
	['minecraft:tallgrass', 767],
	['minecraft:log2', 768],
	...
	['minecraft:wood', 775],
	['minecraft:music_disc_creator', 776],
	['minecraft:music_disc_creator_music_box', 777],
	['minecraft:music_disc_precipice', 778],
	['minecraft:chemistry_table', 779],
	['minecraft:hard_stained_glass', 780],
	['minecraft:hard_stained_glass_pane', 781],
	['minecraft:colored_torch_rg', 782],
	['minecraft:colored_torch_bp', 783],
	['minecraft:light_block', 784],
	['minecraft:boat', 785],
	['minecraft:dye', 786],
	['minecraft:banner_pattern', 787],
	['minecraft:spawn_egg', 788],
	['minecraft:end_crystal', 789],
	['minecraft:glow_berries', 790]
]);
